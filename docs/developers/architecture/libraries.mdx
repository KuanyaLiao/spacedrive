...
You must create a library to use Spacedrive. Users can also choose to create more libraries, such as ones specifically for work. Spacedrive will run all your libraries in unison.
